package com.kishore.udemy.restfulwebservices;
...
public class SwaggerConfig {
	 ...
	 public static final Contact DEFAULT_CONTACT = new Contact("Udemy", "http://www.udemy.com", "email@gmail.com");
	  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Awesome API Title",
			  "Awesome Documentation", "1.0", "urn:tos",
